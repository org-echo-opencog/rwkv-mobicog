...
int main(int argc, char **argv) {
    ...
    rwkvmobile_runtime_load_vision_encoder(runtime, model_id, argv[2]);
    ...
    rwkvmobile_runtime_set_image_prompt(runtime, model_id, argv[4]);



    rwkvmobile_runtime_eval_chat_with_history_async(runtime, model_id, prompt_list, 1, 500, nullptr, 0);
